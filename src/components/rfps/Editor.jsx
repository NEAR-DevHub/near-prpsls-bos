                  ...
                  <div className="d-flex flex-column gap-2">
                    <div className="d-flex gap-3 mt-2">
                      ...
                      <div className="d-flex flex-column gap-3">
                        ...
                        >
                          <div>
                            During this stage, the RFP is still open for
                            submissions.
                          </div>
                        </TimelineItems>
                        <TimelineItems
                          title="2) Evaluation"
                          value={TIMELINE_STATUS.EVALUATION}
                        >
                          <div>
                            This RFP is closed for submissions. All submitted
                          ...
                          <div className="d-flex flex-column gap-2">
                            ...
                            <Widget
                              ...
                              props={{
                                value: "",
                                label: (
                                  <div className="fw-bold">RFP Cancelled</div>
                                ),
                                isChecked:
                                  timeline.status === TIMELINE_STATUS.CANCELLED,
                                onClick: (v) => {
